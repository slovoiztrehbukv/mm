...
if(!function_exists('getMessageTpl')){
    function getMessageTpl($tpl, $data = []) {
        return view("messages.$tpl", $data)->render();
    }
}

if(!function_exists('puntoSwitcher')){
    function puntoSwitcher($text,$arrow=0){
...
if(!function_exists('checkTelegramAuthorization')){
    function checkTelegramAuthorization($auth_data) {
        ...
        $secret_key = hash('sha256', env('MM_TELEGRAM_BOT_TOKEN'), true);
