        ...
        <>
            <div className="container text-center">
                ...
                <section className="mt-16 flex flex-col md:flex-row gap-12 justify-between w-11/12 mx-auto">
                    <button
                        className="w-full lg:w-1/3 disabled:bg-gray-600 disabled:cursor-not-allowed bg-primary-100 hover:bg-primary-500 text-white font-light py-2 rounded shadow-lg hover:shadow-xl transition duration-200"
