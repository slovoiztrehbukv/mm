...
return [
    ...
    */
    'bots'                         => [
        'mm' => [
            'token'               => env('MM_TELEGRAM_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path'    => env('MM_TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('MM_TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
